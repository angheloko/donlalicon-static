<template>
  <div class="page-wrapper">
    <header>
      <a href="/" class="site-name">// donlalicon.dev</a>
    </header>
    <main>
      <Nuxt />
    </main>
    <footer>
      ...
      <a href="https://twitter.com/DonOrDoNot" target="_blank" class="social">
      ...
      <a href="https://github.com/angheloko" target="_blank" class="social">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
      ...
      <a href="https://www.linkedin.com/in/dalalicon" target="_blank" class="social">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
      ...
      <a href="mailto:dalalicon@gmail.com" target="_blank" class="social">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
