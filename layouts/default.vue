<template>
  <div class="flex flex-col min-h-screen">
    ...
    <footer class="flex text-sm text-gray-600 justify-center p-4 bg-gray-100">
      ...
      <a href="https://github.com/angheloko" target="_blank" class="h-6 w-6 ml-2">
        <svg class="fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
      ...
      <a href="https://www.linkedin.com/in/dalalicon" target="_blank" class="h-6 w-6 ml-2">
        <svg class="fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
      ...
      <a href="mailto:dalalicon@gmail.com" target="_blank" class="h-6 w-6 ml-2">
        <svg class="fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
